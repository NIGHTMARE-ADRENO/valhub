...
import { faBars, faCircleChevronRight, faPaperPlane, faSmile } from "@fortawesome/free-solid-svg-icons";
...
function Privatelogs({ message, userid }: Privatelogsprop) {
    return (
        <div className={`max-w-[80%] h-fit p-2 my-2 bg-black text-white ${userid == 191 ? 'ms-auto' : 'me-auto'}`}>{message}</div>
    )
}
